...
class CurrencyToConvertTableViewController: UIViewController {
...
extension CurrencyToConvertTableViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        printContent("test")
    }
}

extension CurrencyToConvertTableViewController: UITableViewDataSource {
